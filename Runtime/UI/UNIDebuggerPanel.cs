...
namespace UNIHper.UI
{
    public class UNIDebuggerPanel : UIBase
    {
        ...
        private void Start()
        {
            ...
            this.Get<Button>("window_settings/btn_apply")
                ...
                .Subscribe(_ =>
                {
                    ...
                    var _width = this.Get<TMP_InputField>("window_settings/input_width").text.Parse2Int();
                    var _height = this.Get<TMP_InputField>("window_settings/input_height").text.Parse2Int();
                    ...
                    _appConfig.PrimaryScreen.Mode = _fullScreen ? FullScreenMode.FullScreenWindow : FullScreenMode.Windowed;
        ...
        private void loadDefaultValues()
        {
            ...
            this.Get<TMP_InputField>("window_settings/input_x").text = _appConfig.PrimaryScreen.PosX.ToString();

            this.Get<TMP_InputField>("window_settings/input_y").text = _appConfig.PrimaryScreen.PosY.ToString();
            ...
            this.Get<Toggle>("window_settings/switch_fullscreen").isOn = _fullScreen == FullScreenMode.FullScreenWindow;

            this.Get<Toggle>("window_settings/switch_caption").isOn = _appConfig.PrimaryScreen.UseTitleBar;
        ...
        private void RefreshScreen()
        {
            ...
            if (_primaryScreen.Width < _minWindownSize.x || _primaryScreen.Height < _minWindownSize.y)
            {
