...
public class SelectRectArea : MonoBehaviour
{
    ...
    {
        return Observable.FromEvent<int>(_action=>Handler+=_action,_action=>Handler-=_action);
    }
    ...
    private void startRect()
    {
        ...
        Observable.EveryUpdate().Where(_=>Input.GetMouseButtonDown(0)
                &&((HoldKey!=KeyCode.None&&Input.GetKey(HoldKey))||HoldKey==KeyCode.None)
                &&((NotHoldKey!=KeyCode.None&&!Input.GetKey(NotHoldKey))||NotHoldKey==KeyCode.None)
            )
            .Subscribe(_=>{
        ...
        Observable.EveryUpdate().Where(_=>_pressed
                &&((HoldKey!=KeyCode.None&&Input.GetKey(HoldKey))||HoldKey==KeyCode.None)
                &&((NotHoldKey!=KeyCode.None&&!Input.GetKey(NotHoldKey))||NotHoldKey==KeyCode.None)
            )
            .Subscribe(_=>{
        ...
        Observable.EveryUpdate().Where(_=>Input.GetMouseButtonUp(0)
                &&((HoldKey!=KeyCode.None&&Input.GetKey(HoldKey))||HoldKey==KeyCode.None)
                &&((NotHoldKey!=KeyCode.None&&!Input.GetKey(NotHoldKey))||NotHoldKey==KeyCode.None)
            )
            .Subscribe(_=>{
    ...
    void calcRect(Vector3 InPoint1, Vector3 InPoint2, out Vector3 _leftLower, out Vector3 _rightUpper){
        _leftLower = InPoint1;
