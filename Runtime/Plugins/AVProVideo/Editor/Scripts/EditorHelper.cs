    ...
    public static class EditorHelper
    {
        ...
        internal static List<string> GetEditorPrefsToStringList(string key, char separator = ';')
        {
            ...
            return new List<string>(
                items.Split(new char[] { separator }, System.StringSplitOptions.RemoveEmptyEntries)
            );
        }
        ...
        /// </summary>
        internal static void SetEditorPrefsFromStringList(
            string key,
            List<string> items,
            char separator = ';'
        )
        ...
        public static SerializedProperty CheckFindProperty(
            this UnityEditor.Editor editor,
            string propertyName
        )
        {
        ...
        /// </summary>
        internal static bool HasScriptDefine(
            string define,
        ...
        /// </summary>
        internal static void AddScriptDefine(
            string define,
            BuildTargetGroup buildTarget = BuildTargetGroup.Unknown
        )
        {
        ...
        /// </summary>
        internal static void RemoveScriptDefine(
            string define,
            BuildTargetGroup buildTarget = BuildTargetGroup.Unknown
        )
        {
        ...
        internal static bool OpenMediaFileDialog(
            string startPath,
            ref MediaPath mediaPath,
            ref string fullPath,
            string extensions
        )
        {
        ...
        private static string GetPathRelativeTo(string root, string fullPath)
        {
            ...
            if (
                result.StartsWith(System.IO.Path.DirectorySeparatorChar.ToString())
                || result.StartsWith(System.IO.Path.AltDirectorySeparatorChar.ToString())
            )
            {
        ...
        internal static MediaPath GetMediaPathFromFullPath(string fullPath)
        {
            ...
            if (fullPath.StartsWith(projectRoot))
            {
                if (fullPath.StartsWith(Application.streamingAssetsPath))
                {
                    ...
                    result = new MediaPath(
                        GetPathRelativeTo(Application.streamingAssetsPath, fullPath),
                ...
                else if (fullPath.StartsWith(Application.dataPath))
                {
                    ...
                    result = new MediaPath(
                        GetPathRelativeTo(Application.dataPath, fullPath),
                ...
                else
                {
                    ...
                    result = new MediaPath(
                        GetPathRelativeTo(projectRoot, fullPath),
                        MediaPathType.RelativeToProjectFolder
                    );
                }
            }
            else
            {
                ...
                {
                    result = new MediaPath(
                        GetPathRelativeTo(Application.persistentDataPath, fullPath),
        ...
        internal class IMGUI
        {
            ...
            /// </summary>
            internal static void WarningTextBox(
                string title,
                string body,
                Color bgColor,
                Color titleColor,
            ...
            /// Displays an IMGUI warning text box inline
            /// </summary>
            internal static void BeginWarningTextBox(
                string title,
                string body,
                Color bgColor,
                Color titleColor,
            ...
            internal static void CopyableFilename(string path)
            {
                ...
                if (
                    ...
                    && 0 > path.IndexOfAny(System.IO.Path.GetInvalidPathChars())
                )
                {
                    ...
                    float height =
                        _copyableStyle.CalcHeight(new GUIContent(text), Screen.width) * 1.5f;
            ...
            internal static bool ToggleScriptDefine(string label, string define)
            {
                ...
                bool isEnabled = EditorGUILayout.Toggle(
                    label,
                    EditorHelper.HasScriptDefine(define)
                );
