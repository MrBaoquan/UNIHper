...
namespace RenderHeads.Media.AVProVideo
{
	...
	{
		public const string AVProVideoVersion             = "2.0.10";
		public const string ExpectedPluginVersion_Windows = "2.0.10";
		public const string ExpectedPluginVersion_WinRT   = "2.0.10";
		public const string ExpectedPluginVersion_Android = "2.0.4";
		public const string ExpectedPluginVersion_Apple   = "2.0.10";
